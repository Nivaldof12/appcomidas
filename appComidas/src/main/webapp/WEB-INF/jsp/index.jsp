		...
		<div class="custom-card">
			<div class="card shadow">
				<div class="card-header">
					...
					<h6 class="card-subtitle mb-2 text-muted">Cadastre alimentos e
						faça pedidos pelo site</h6>
				</div>
				<img class="card-img-top"
					src="${pageContext.request.contextPath}/static/img/restaurante.png"
				...
				<div class="card-body">
					<p>
						...
						sugestão. <br> Para logar como administrador no sistema use: <br>
						Login: admin@admin.com <br> senha:123 <br> <br> By:
						Nivaldo Ferreira de souza Filho
					</p>
				</div>
			</div>
		</div>
